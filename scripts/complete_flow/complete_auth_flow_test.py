...
# O Firebase Admin SDK não é utilizado neste script, pois a autenticação é feita via API REST.
# O código relacionado à sua inicialização foi removido para otimização e clareza.
