...
STUDENT_ENDPOINTS = {
    ...
    "get_history": {
        "method": "GET",
        "path": "/student/students/me/history",
        "description": "Obtém histórico de resgates do estudante",
        "params": ["limit", "offset"],
    },
    "get_favorites": {
        "method": "GET",
        "path": "/student/students/me/fav",
    ...
    "remove_favorite": {
        "method": "DELETE",
        "path": "/student/students/me/fav/{pid}",
...
PARTNER_ENDPOINTS = {
    "redeem_code": {
        "method": "POST",
        "path": "/partner/partner/redeem",
        "description": "Resgata código de validação",
        "body_required": True,
        "rate_limited": True,
    },
    "list_promotions": {
        "method": "GET",
        "path": "/partner/partner/promotions",
        "description": "Lista promoções do parceiro",
        "params": ["limit", "offset"],
    },
    "create_promotion": {
        "method": "POST",
        "path": "/partner/partner/promotions",
        "description": "Cria nova promoção",
        "body_required": True,
    },
    "update_promotion": {
        "method": "PUT",
        "path": "/partner/partner/promotions/{id}",
        "description": "Atualiza promoção existente",
        "path_params": ["id"],
        "body_required": True,
    },
    "delete_promotion": {
        "method": "DELETE",
        "path": "/partner/partner/promotions/{id}",
        "description": "Remove promoção",
        "path_params": ["id"],
    },
    "get_reports": {
        "method": "GET",
        "path": "/partner/partner/reports",
        "description": "Obtém relatórios do parceiro",
        "params": ["range"],
    },
}
