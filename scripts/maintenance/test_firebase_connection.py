    ...
    try:
        ...
        try:
            ...
            firebase_admin.initialize_app(
                cred, {"storageBucket": "knn-benefits-default.appspot.com"}
            )
...
def test_storage_access():
    ...
    try:
        ...
        try:
            ...
            print(
                f"✅ Listagem de arquivos funcionando ({len(blobs)} arquivo(s) encontrado(s))"
            )
        except Exception as e:
...
def test_firestore_access():
    ...
    try:
        ...
        try:
            ...
            print(
                f"✅ Acesso à coleção 'partners' funcionando ({len(docs)} documento(s) encontrado(s))"
            )
...
def main():
    ...
    if not test_firebase_initialization():
        ...
        print("\n💡 SOLUÇÕES POSSÍVEIS:")
        print(
            "1. Configure GOOGLE_APPLICATION_CREDENTIALS com caminho para arquivo de credenciais"
        )
        print(
            "2. Execute 'gcloud auth application-default login' se tiver gcloud instalado"
        )
    ...
    if storage_ok and firestore_ok:
        ...
        print(
            "❌ Alguns testes falharam. Verifique as configurações antes de prosseguir."
        )
        return False
